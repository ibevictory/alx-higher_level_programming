...
Project done during **Full Stack Software Engineering studies** at **alx_Africa**. It aims to learn about object oriented programming (OOP), mutability, identity and data types in **Python**.
